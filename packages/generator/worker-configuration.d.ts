/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false --env production` (hash: e11ad0553e293c85fa1d12418b8219d2)
// Runtime types generated with workerd@1.20260124.0 2026-02-05 
declare namespace Cloudflare {
	...
	interface Env {
		...
		FEEDGEN_HOST: string;
		FEEDGEN_AUTH_REQUIRED: string;
		DID_CACHE_TTL_SECONDS: string;
		DID_CACHE_REVALIDATE_INTERVAL_SECONDS: string;
		DID_CACHE_TIMESTAMP_GRANULARITY_SECONDS: string;
