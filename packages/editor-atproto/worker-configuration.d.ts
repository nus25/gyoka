/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=production --strict-vars=false` (hash: 0832d95722f6793b62d831b066df2d0a)
// Runtime types generated with workerd@1.20260730.1 2026-02-05 
interface __BaseEnv_Env {
	DB: D1Database;
	GYOKA_EDITOR_HOST: string;
	GYOKA_EDITOR_AUTH_REQUIRED: string;
	GYOKA_EDITOR_ADMIN_DIDS: string;
	DID_CACHE_TTL_SECONDS: string;
	DEVELOPER_MODE: string;
	D1_USE_SESSION: string;
	VERSION: string;
	GIT_SHA: string;
}
