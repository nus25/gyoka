...
const _entryInputSchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("net.nusno.gyoka.feed.batchAddPosts#entryInput")),
...
const _entryResultSchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("net.nusno.gyoka.feed.batchAddPosts#entryResult")),
		"feed": /*#__PURE__*/ v.resourceUriString(),
		get "results"() {
...
const _postInputSchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("net.nusno.gyoka.feed.batchAddPosts#postInput")),
...
const _postResultSchema = /*#__PURE__*/ v.object({
	"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("net.nusno.gyoka.feed.batchAddPosts#postResult")),
...
const _skeletonReasonPinSchema = /*#__PURE__*/ v.object({
	"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("net.nusno.gyoka.feed.batchAddPosts#skeletonReasonPin")),
});
const _skeletonReasonRepostSchema = /*#__PURE__*/ v.object({
	"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("net.nusno.gyoka.feed.batchAddPosts#skeletonReasonRepost")),
